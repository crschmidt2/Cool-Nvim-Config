...
return {
    ...
    -- },
    {
        ...
        lazy = true,
        keys = {
            { '<leader>lo', desc = 'Plain log below' },
            { '<leader>lO', desc = 'Plain log above' },
            { '<leader>lj', desc = 'Variable log below' },
            { '<leader>lk', desc = 'Variable log above' },
            { '<leader>lS', desc = 'Surround line with plain logs' },
            { '<leader>ls', desc = 'Surround variable with logs' },
            { '<leader>lt', desc = 'Toggle comment debug prints' },
            { '<leader>ld', desc = 'Delete debug prints' },
        },
        opts = {
