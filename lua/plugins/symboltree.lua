return {
  ...
  --     event = "VeryLazy",
  --     keys = {
  --       { "<C-c>", "<cmd>AerialToggle<CR>", desc = "Open symbol tree" }
  --     },
  --     opts = {
  --       -- code-- Call the setup function to change the default behavior
  ...
  --         win_opts = {winhl='EndOfBuffer:NvimTreeEndOfBuffer,Normal:NvimTreeNormal'},
